    ...
    <div class="container text-center text-md-left">
        <div class="row my-4">
            ...
            <div class="col-md-4 col-lg-3">
                <h5 class="text-uppercase mb-4 font-weight-bold">BusinessM</h5>
                <p>Our team provides facility to manage your business activity at anytime, anywhere</p>
                <p>A dynamic way to manage business such us, shop, supermarket, etc </p>
            </div>
            <!--/.First column-->
            ...
            <div class="col-md-4 col-lg-3">
                ...
                <!--Info-->
                <p>
                    <i class="fa fa-home mr-3"></i>Glocal University, Mirzapur pole, Saharanpur</p>
                <p>
                    <i class="fa fa-envelope mr-3"></i>dosso.gu16r0008@glocal.university</p>
                <p>
                    <i class="fa fa-phone mr-3"></i>+91 8560165917</p>
            </div>
            <!--/.Third column-->
